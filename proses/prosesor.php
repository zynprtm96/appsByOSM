...
$sql = "INSERT INTO order_lab(dimensia, dimensib, ed, dbl, pv, sh, pt, bvd, model_f, sphrsek, cylrsek, axrsek, sphlsek, cyllsek, axlsek, adisirsek, adisilsek, prisrsek, prislsek, basersek, baselsek, pdr, pdl, pd, pdd,nonotaor,nota_ref,merk_f,jenis_f,warna_f, ucvar, bcvar, ucval, bcval,petugas,pemeriksa,statrekam )VALUES('$dimensia','$dimensib','$ed', '$dbl', '$pv','$sh','$pt', '$bvd', '$model_f', '$sphrsek', '$cylrsek', '$axrsek','$sphlsek','$cyllsek', '$axlsek','$adisirsek','$adisilsek', '$prisrsek','$prislsek','$basersek','$baselsek', '$pdr','$pdl','$pd','$pdd','$nonota','$nota_ref','$merk_f','$detil_f','$warna_f', '$ucvar', '$bcvar', '$ucval', '$bcval','$petugas','$pemeriksa','$statrekam' )";
$stat = "UPDATE nota_pesan SET stator='T' where id='$id'";
...
if( $masuk ) {
  ...
  window.setTimeout(function(){ 
   window.location.replace('../kar/cetakor.php?id=$nonota');
  } ,2000); 
 </script>
   ";
