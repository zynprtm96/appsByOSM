        ...
        if ($hitung_data > 0) {
            while ($data = mysqli_fetch_array($query)) {
                ...
                <tr align="center"   >
                    ...
                    <td><a href="../kar/cetaknotakontan.php?nonota=<?php echo $data['nonota'];?>" title="Cetak Nota"><button type="button" class="btn btn-primary"><i class='bx bx-printer'></i></button></a></td>
