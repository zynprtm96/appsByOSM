...
<table class="table  container" style="font-size: 14px;">
    ...
    <tbody>
        ...
        $query = mysqli_query($konek,"SELECT * FROM nota_kontan WHERE nonota LIKE '%".$keyword."%' OR nama LIKE '%".$keyword."%'  ORDER BY nonota DESC");
  ...
  content: "input",
    ...
    window.location = "../proses/batalkontan.php?id="+ id + "&alasan="+ value + "&nota=<?php echo $nb?>";
