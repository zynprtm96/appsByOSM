...
$sql = "INSERT INTO rekam_medis (noresep, nama, usia, nohp, alamat, sphrsek, cylrsek, axrsek, sphlsek, cyllsek, axlsek,ucvar, bcvar, ucval, bcval, pdr, pdl, pd, pdd, anamnesa, pbr, pbl, ksr, ksl, lmr, lml, kmr, kml, sphrseb, cylrseb, axrseb, sphlseb, cyllseb, axlseb, jlseb, alat, sphralat, cylralat, axralat, sphlalat, cyllalat, axlalat, phl, phr, tkb, ttab, diagnosa, analisa, terapi, kesimpulan, pemeriksa, adisirsek,adisilsek, prisrsek, prislsek, basersek, baselsek, adisirseb, adisilseb, prisrseb, prislseb, baserseb, baselseb,id_pasien,norekam) VALUES ('$noresep', '$nama', '$usia', '$nohp', '$alamat', '$sphrsek', '$cylrsek', '$axrsek', '$sphlsek', '$cyllsek', '$axlsek', '$ucvar', '$bcvar', '$ucval', '$bcval', '$pdr', '$pdl', '$pd', '$pdd', '$anamnesa', '$pbr', '$pbl', '$ksr', '$ksl', '$lmr', '$lml', '$kmr', '$kml', '$sphrseb', '$cylrseb', '$axrseb', '$sphlseb', '$cyllseb', '$axlseb', '$jlseb', '$alat', '$sphralat', '$cylralat', '$axralat', '$sphlalat', '$cyllalat', '$axlalat', '$phl', '$phr', '$tkb', '$ttab', '$diagnosa', '$analisa', '$terapi', '$kesimpulan', '$pemeriksa', '$adisirsek','$adisilsek', '$prisrsek', '$prislsek', '$basersek', '$baselsek', '$adisirseb', '$adisilseb', '$prisrseb', '$prislseb', '$baserseb', '$baselseb','$id_pasien','$norekam')";
...
if( $query ) {
    echo  "<script>alert('Rekam Medis Berhasil Ditambahkan');window.location='../kar/resepid.php?id=$noresep'</script>";
