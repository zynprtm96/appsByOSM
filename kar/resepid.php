...
<?php
        ...
        $id=$_GET['id'];
        $query = mysqli_query($konek, "SELECT * FROM rekam_medis where noresep='$id'");
    ...
    <main>
         ...
         <div class="container" >
            ...
            <div class="row-dalam">
               ...
               <center><h5 style="font-size: 16px; font-weight:900;">DIAGNOSA PEMERIKSAAN REFRAKSI MATA</h5></center>
               ...
               <p <?php echo $ukuran;?> style="text-align: center;">Belum Pernah Menggunakan Kacamata</p>
               ...
               <p style="text-align: center;">Pemeriksaan Refraksi Objektif</p>
