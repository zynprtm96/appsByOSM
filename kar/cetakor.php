...
<link rel="stylesheet" href="../aset/css/side.css" />
    ...
    <?php
        ...
        $id = $_GET['id'];
        $query = mysqli_query($konek, "SELECT * FROM order_lab INNER JOIN nota_pesan on order_lab.nota_ref=nota_pesan.nonota WHERE order_lab.nonotaor='$id'");
         ...
         <div class="container" >
            ...
            <div class="row-dalam">
                    ...
                    <div class="col" >
                        ...
                        <tr style="font-size: 12px;font-weight:900; ">
                            <td>Nota Pesan</td>
                            <td>&ensp;: <?php echo $nota = $data['nonota'];?></td>
                          </tr>
                          <tr>
                            <td>Nama</td>
                          ...
                          <tr>
                            ...
                            <td>&ensp;: <?php echo $nota = date('d M Y',strtotime($data['tanggal_pesan']));?></td>
                          </tr>
                        </table>
               ...
               <div style="border-top: 2px solid #000; margin-top: 1em; padding-top: 1em;"> </div>
                ...
                <tr >
                    <td align="left" width="15%">Frame</td>
                    <td  >: <?php echo $nota = $data['kode_f'];?> <?php echo $nota = $data['merk_f'];?> <?php echo $nota = $data['warna_f'];?> (<?php echo $nota = $data['detil_f'];?>)</td>
                    
                    <td rowspan="<?php echo $row;?>" style="vertical-align: middle;text-align:right;">Model RIM : <?php echo $nota = $data['model_f'];?></td>
                    <td rowspan="<?php echo $row;?>">
                    <img src="../aset/img/<?php echo $rim ;?>" width="90px"  />
                    </td>
                </tr>
                <tr <?php echo $lensa;?>>
                    <td align="left">Lensa</td>
                    <td  >: <?php echo $nota = $data['kode_lr'];?> <?php echo $nota = $data['merk_lr'];?> <?php echo $nota = $data['jenis_lr'];?> </td>
                ...
                <tr <?php echo $lensaod;?>>
                    ...
                    <td  >: <?php echo $nota = $data['kode_ll'];?> <?php echo $nota = $data['merk_ll'];?> <?php echo $nota = $data['jenis_ll'];?> </td>
               ...
               <table class="table table-bordered" style="text-align: center;" >
                ...
                <tr>
                <td>OD</td>
                    <td><?php echo $nota = $data['sphrsek'];?></td>
                    <td><?php echo $nota = $data['cylrsek'];?></td>
                    <td><?php echo $nota = $data['axrsek'];?></td>
                   
                    <td><?php echo $nota = $data['adisirsek'];?></td>
                    <td><?php echo $nota = $data['pdr'];?></td>
                    <td style="border: 0;"></td>
                    <td><?php echo $data['dimensia']?></td>
                    <td><?php echo $data['dimensib']?></td>
                    <td><?php echo $data['ed']?></td>
                    <td><?php echo $data['dbl']?></td>
                    <td><?php echo $data['pv']?></td>
                    <td><?php echo $data['sh']?></td>
                    <td><?php echo $data['pt']?></td>
                    <td><?php echo $data['bvd']?></td>
                </tr>
                <tr>
                <td>OS</td>
                    <td><?php echo $nota = $data['sphlsek'];?></td>
                    <td><?php echo $nota = $data['cyllsek'];?></td>
                    <td><?php echo $nota = $data['axlsek'];?></td>
                    
                    <td><?php echo $nota = $data['adisilsek'];?></td>
                    <td><?php echo $nota = $data['pdl'];?></td>
                    <td style="border: 0;"></td>
                    
                </tr>
                <tr>
                    <td colspan="2" align="right" style="border:0;">PD Jauh</td>
                    <td style="border: 0;"><?php echo $nota = $data['pd'];?></td>
                    <td colspan="2" align="right" style="border:0;">PD Dekat</td>
                    <td  style="border: 0;"><?php echo $nota = $data['pdd'];?></td>
                </tr>
               ...
               <a href="../kar/rekamor.php?id=<?php echo $data['id']?>" style="margin-left: 20px;" type="button" class="btn btn-warning">Isi Rekam Medis</a>
