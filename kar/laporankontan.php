...
<table class="table container" style="font-size: 14px;">
    ...
    <tbody>
        ...
        if (isset($_POST['search'])) {
            ...
            $query = mysqli_query($konek,"SELECT * FROM nota_kontan WHERE nonota LIKE '%".$keyword."%' OR nama LIKE '%".$keyword."%'  OR nohp  LIKE '%".$keyword."%' ORDER BY nonota DESC");
        }elseif (isset($_POST['range'])) {
            $date1 = $_POST['date1'];
            $date2 = $_POST['date2'];
            $query = mysqli_query($konek,"SELECT * FROM nota_kontan WHERE tanggal_transaksi BETWEEN '$date1' and '$date2' order by id desc");
        }elseif(isset($_POST['reset'])){
            $query = mysqli_query($konek,"SELECT * FROM nota_kontan order by id desc");
        ...
        if ($hitung_data > 0) {
            ...
            while ($data = mysqli_fetch_array($query)) {
                ...
                <tr align="center" class="<?php echo $kelas ?>"  >
                    ...
                    <td ><?php echo $data['produk_1']; ?> <?php echo $data['produk_2']; ?> <?php echo $data['produk_3']; ?> <?php echo $data['produk_4']; ?> <?php echo $data['produk_5']; ?></td>
