...
<link rel="stylesheet" href="../aset/css/side.css" />
    ...
    <?php
        ...
        $id = $_GET['id'];
        $query = mysqli_query($konek, "SELECT * FROM order_lab  JOIN nota_garansi on order_lab.nota_ref=nota_garansi.nonotagr WHERE order_lab.nota_ref='$id'");
