...
<header class="header">
    ...
    <br>
    <a  href="../kar/pemeriksaan.php" class="btn btn-primary">Buat Baru</a>
    <a  href="../kar/orrekam.php" class="btn btn-primary">Lengkapi Data</a>
    </div>
    <br>
    <h5 style="text-align: center;">DAFTAR REKAM MEDIS</h5>
