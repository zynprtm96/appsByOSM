...
<header class="header">
   ...
   <br>
     <div>
     <a href="../kar/laporanproduk.php" type="button" class="btn btn-danger">Kembali</a>
    ...
    <h4 style="text-align: center;">Laporan Penjualan Frame</h4>
<table class="table container" style="font-size: 14px;">
    ...
    <tbody>
        ...
        $keyword="";
            ...
            $query = mysqli_query($konek,"SELECT * FROM produk where jenis='FRAME' order by stok desc");
