...
<meta charset="utf-8">
  ...
  <link rel="stylesheet" href="../aset/boot/css/bootstrap.min.css">
...
<link rel="stylesheet" href="../aset/css/side.css" />
 ...
 $id = $_GET['id'];
        ...
        $query = mysqli_query($konek, "SELECT * FROM rekam_medis join rujukan on rekam_medis.noresep = rujukan.noresep where rekam_medis.id='$id' ");
    ...
    <main>
         ...
         <div class="container"  >
            ...
            <div class="rangkasurat" id="div1">
               ...
               <center><h5 style="font-size: 16px; font-weight:900;">Surat Rujukan</h5></center>
...
<div class="chapter">
               ...
               <table class="table table-borderless">
                <tr>
                  <td width="30%">JENIS LENSA SEBELUM</td>
                  <td><?php echo $data['jlseb'];?></td>
                </tr>
               ...
               <table class="table table-bordered" style="text-align: center;" <?php echo $alkes?> >
                <tr>
                    <td></td>
                    <td>SPH</td>
                    <td>CYL</td>
               ...
               <table class="table table-borderless">
                    ...
                    <tr>
                            ...
                            <td>OD : <?php echo $data['phr'];?> </td>
                            <td>OS : <?php echo $data['phl'];?>  </td>
                    </tr>
                    <tr>
                            <td width="30%">Tes Keseimbangan Binokular</td>
                           
                            <td>: <?php echo $data['tkb'];?></td>
                            <td width="30%">Tes Titik Akhir Binokular</td>
                           
                           <td>: <?php echo $data['ttab'];?></td>
                    </tr>
                    <tr>
