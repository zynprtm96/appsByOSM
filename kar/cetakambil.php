...
<link rel="stylesheet" href="../aset/css/side.css" />
  <?php
    ...
    <title>Nota Pengambilan No: <?php echo $data['nonota']?> <?php echo $data['nama']?></title>
    <script>
            ...
            <div class="row-dalam">
                    ...
                    <div class="col" >
                        ...
                        <tr style="font-size: 12px;font-weight:900; ">
                          ...
                          <tr>
                            ...
                            <td>&ensp;: <?php echo $nota = date('d M Y');?></td>
                          </tr>
                        </table>
               ...
               <table class="table table-borderless" style="border-bottom: 1px solid #000;">
                <tr <?php echo $frame;?>>
                    ...
                    <td width="65%" >: <?php echo $nota = $data['kode_f'];?> <?php echo $nota = $data['detil_f'];?> <?php echo $nota = $data['merk_f'];?> <?php echo $nota = $data['warna_f'];?></td>
                ...
                <tr <?php echo $lensaod;?>>
                    ...
                    <td width="65%">: <?php echo $nota = $data['kode_ll'];?> <?php echo $nota = $data['merk_ll'];?> <?php echo $nota = $data['jenis_ll'];?> </td>
                    <td align="">: Rp. <?php echo $nota = number_format($data['harga_ll']);?> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="table-success" width="20%">LUNAS </td>
                </tr>
               </table><br>
               <div class="row-dalam">
                  <div class="col-3">
               ...
               <a href="../kar/pengambilan.php" style="margin-left: 20px;" type="button" class="btn btn-danger">Kembali</a>
