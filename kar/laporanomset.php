...
<a href="../kar/laporanomsetgrafik.php" type="button" class="btn btn-primary">Grafik</a>
    ...
    <h4 style="text-align: center;">Laporan Omset</h4>
<table class="table container" style="font-size: 14px;">
    ...
    <tbody>
        ...
        if (isset($_POST['search'])) {
            ...
            $query = mysqli_query($konek,"SELECT * FROM omset WHERE nonota LIKE '%".$keyword."%'  ORDER BY nonota DESC");
        }elseif (isset($_POST['range'])) {
            $date1 = $_POST['date1'];
            $date2 = $_POST['date2'];
            $query = mysqli_query($konek,"SELECT * FROM omset WHERE tanggal BETWEEN '$date1' and '$date2' order by id desc");
        }elseif(isset($_POST['reset'])){
            $query = mysqli_query($konek,"SELECT * FROM omset order by id desc");
        ...
        if ($hitung_data > 0) {
            ...
            while ($data = mysqli_fetch_array($query)) {
                ...
                <tr align="center"  >
                    ...
                    <td ><?php echo number_format($data['pembayaran']); ?></td>
            ...
            <tr class="table-success">
				<td colspan="2" align="center"> Jumlah Omset</td>
				<td align="center">
