...
<link rel="stylesheet" href="../aset/css/side.css" />
    ...
    <?php
        ...
        $id =$_GET['id'];
        $query = mysqli_query($konek, "SELECT * FROM nota_batal where id='$id'");
            ...
            <div class="rangkasurat" id="div1">
                    ...
                    <div class="col" >
                        ...
                        <tr style="font-size: 12px;font-weight:900; ">
                          ...
                          <tr>
                            ...
                            <td>&ensp;: <?php echo $nota = date('d M Y',strtotime($data['tanggal_batal']));?></td>
                          </tr>
                        </table>
               ...
               <table class="table table-borderless" style="border-bottom: 1px solid #000;">
                <tr <?php echo $frame;?>>
                    ...
                    <td width="65%" >: <?php echo $nota = $data['merk_f'];?> <?php echo $nota = $data['detil_f'];?> </td>
               ...
               Alasan Batal : <?php echo $nota = $data['alasan'];?> 
               <div class="row-dalam">
                  <div class="col-3">
