            ...
            <div class="row-dalam">
               ...
               <table class="table table-borderless" style="border-bottom: 1px solid #000;">
                <tr <?php echo $frame;?>>
                    ...
                    <td width="65%" >: <?php echo $nota = $data['detil_f'];?> <?php echo $nota = $data['merk_f'];?> <?php echo $nota = $data['warna_f'];?></td>
                    <td align="" >: Rp. <?php echo $nota = number_format($data['harga_f']);?> </td>
                </tr>
                <tr <?php echo $lensa;?>>
                    <td align="left">Lensa</td>
                    <td width="65%">: <?php echo $nota = $data['merk_lr'];?> <?php echo $nota = $data['jenis_lr'];?> </td>
                ...
                <tr <?php echo $lensaod;?>>
                    ...
                    <td width="65%">: <?php echo $nota = $data['merk_ll'];?> <?php echo $nota = $data['jenis_ll'];?> </td>
