...
<link rel="stylesheet" href="../aset/css/side.css" />
    <?php
        ...
        $query = mysqli_query($konek, "SELECT * FROM nota_pesan ORDER BY id DESC");
    ...
    <title><?php echo $nota = $data['nonota'];?></title>
    <script>
            ...
            <div class="row-dalam">
               ...
               <table class="table table-borderless" style="border-bottom: 1px solid #000;">
                ...
                <tr <?php echo $lensa;?>>
                    ...
                    <td align="">: Rp. <?php echo $nota = number_format($data['subhargalensa']);?> </td>
                </tr>
                <tr <?php echo $lensaod;?>>
                    <td align="left">Lensa OD</td>
                    <td  width="65%">: <?php echo $nota = $data['kode_lr'];?> <?php echo $nota = $data['merk_lr'];?> <?php echo $nota = $data['jenis_lr'];?></td>
                    <td align="" rowspan="2" style="vertical-align: middle;">: Rp. <?php echo $nota = number_format($data['subhargalensa']);?> </td>
                </tr>
                <tr <?php echo $lensaod;?>>
               ...
               <a href="../kar/or.php?id=<?php echo $nota = $data['nonota'];?>" type="button" class="btn btn-primary">Order Lensa</a>
