...
<header class="header">
	...
	$sql = mysqli_query($konek,"SELECT max(noresep) as noresep FROM rekam_medis");
  $tanggal=date('d-M-Y');
	...
	?>
    <div class="container"  >
    <h5 style="text-align: center;">Rekam Medis</h5>
    <div class="rangkasurat">
      <form method="post" action="../proses/periksa.php">
      <h5 style="text-align: center;">Identitas</h5>
      
                          <div class="masukan">
                            <input type="text" id="effect5" autocomplete="off" class="effect-5" readonly placeholder=" " name="noresep" value="<?php echo $resep;?>"/>
                            <label for="effect5">No Resep</label>
                          </div>
                          <div class="masukan">
                            <input type="text" id="effect5" autocomplete="off" class="effect-5" value="<?php echo $tanggal ?>" readonly placeholder=" "  />
    ...
    <script>
      $(".theSelect").select2();
                          ...
                          <div class="masukan">
                            <input onkeyup="this.value = this.value.toUpperCase()" value="<?php echo $id_pasien?>" readonly type="text" id="id_pasien" autocomplete="off" class="effect-5" placeholder=" " name="id_pasien" />
                            <label for="effect5">ID Pasien</label>
                          </div>
                          <div class="masukan">
                            <input onkeyup="this.value = this.value.toUpperCase()" value="<?php echo $rekam?>" readonly type="text" id="norekam" autocomplete="off" class="effect-5" placeholder=" " name="norekam" />
                            <label for="effect5">No Rekam Medis</label>
                          </div>
                          <div class="masukan">
                            <input onkeyup="this.value = this.value.toUpperCase()" type="text" id="nama" autocomplete="off" class="effect-5" placeholder=" " name="nama" />
                            <label for="effect5">Nama</label>
                          </div>
                          <div class="masukan">
                            <input onkeyup="this.value = this.value.toUpperCase()" type="text" id="alamat" autocomplete="off" class="effect-5" placeholder=" " name="alamat"  />
                            <label for="effect5">Alamat</label>
                          </div>
                          <div class="masukan">
                            <input type="number" id="usia" autocomplete="off" autocomplete="off" class="effect-5" placeholder=" " name="usia" />
                            <label for="effect5">Usia</label>
                          </div>
                          <div class="masukan">
                            <input type="number" id="nohp" autocomplete="off" class="effect-5" placeholder=" " name="nohp" />
    ...
    <script>
      $(".theSelect").select2();
                          ...
                          <div class="masukan">
                            <input onkeyup="this.value = this.value.toUpperCase()" type="text" id="effect5" autocomplete="off" class="effect-5" placeholder=" " name="anamnesa" />
...
<option value="180">180</option>
		...
		$(".axlsek").select2();
                            ...
                            <div class="col">
                                <input type="text" id="effect5" class="effect-5" autocomplete="off" placeholder=" " name="prisrseb"  />
                                <label for="effect5">PRIS</label>
                            </div>
                            <div class="col">
                                <input type="text" id="effect5" class="effect-5" autocomplete="off" placeholder=" " name="baserseb"  />
...
<option value="180">180</option>
		...
		$(".axlsek").select2();
                            ...
                            <div class="col">
                                <input type="text" id="effect5" class="effect-5" autocomplete="off" placeholder=" " name="prislseb" />
                                <label for="effect5">PRIS</label>
                            </div>
                            <div class="col">
                                <input type="text" id="effect5" class="effect-5" autocomplete="off" placeholder=" " name="baselseb" />
                                <label for="effect5">BASE</label>
                            </div>
                            <div class="col">
...
<option value="+0.25">+0.25</option>
		...
		$(".adisilsek").select2();
                          ...
                          <div class="row-dalam masukan">
                            ...
                            <div class="col">
                                <input type="text" id="effect5" class="effect-5" autocomplete="off" placeholder=" " name="jlseb" />
...
<option value="180">180</option>
		...
		$(".axrsek").select2();
                            ...
                            <div class="col">
                                <input type="text" id="effect5" autocomplete="off" class="effect-5" placeholder=" " name="ucvar" />
                                <label for="effect5">UCVA</label>
                            </div>
                            <div class="col">
                                <input type="text" id="effect5" class="effect-5" autocomplete="off" placeholder=" " name="bcvar" />
                                <label for="effect5">BCVA</label>
                            </div>
                            <div class="col">
                                <input type="text" id="effect5" class="effect-5" autocomplete="off" placeholder=" " name="prisrsek" />
                                <label for="effect5">PRIS</label>
                            </div>
                            <div class="col">
                                <input type="text" id="effect5" class="effect-5" autocomplete="off" placeholder=" " name="basersek" />
                                <label for="effect5">BASE</label>
                            </div>
                            <div class="col">
...
<option value="180">180</option>
		...
		$(".axlsek").select2();
                            ...
                            <div class="col">
                                <input type="text" id="effect5" autocomplete="off" class="effect-5" placeholder=" " name="ucval" />
                                <label for="effect5">UCVA</label>
                            </div>
                            <div class="col">
                                <input type="text" id="effect5" autocomplete="off" class="effect-5" placeholder=" " name="bcval" />
                                <label for="effect5">BCVA</label>
                            </div>
                            <div class="col">
                                <input type="text" id="effect5" autocomplete="off" class="effect-5" placeholder=" " name="prislsek" />
                                <label for="effect5">PRIS</label>
                            </div>
                            <div class="col">
                                <input type="text" id="effect5" autocomplete="off" class="effect-5" placeholder=" " name="baselsek" />
                                <label for="effect5">BASE</label>
                            </div>
                            <div class="col">
...
<option value="+0.25">+0.25</option>
		...
		$(".adisilsek").select2();
                          ...
                          <div class="row-dalam masukan">
                            ...
                            <div class="col">
                                <input type="text" id="pdr" autocomplete="off" class="effect-5" placeholder=" " name="pdr"  onkeyup="harga()" />
                                <label for="effect5">PD Monokuler Kanan</label>
                            </div>
                            <div class="col">
                                <input type="text" id="pdl" autocomplete="off" class="effect-5" placeholder=" " name="pdl" onkeyup="harga()"  />
                          ...
                          <div class="row-dalam masukan">
                            ...
                            <div class="col">
                                <input type="text" id="pd" autocomplete="off" class="effect-5" placeholder=" " name="pd" onkeyup="harga()" />
                                <label for="effect5">PD Jauh</label>
                            </div>
                            <div class="col">
                                <input type="text" id="pdd" autocomplete="off" class="effect-5" placeholder=" " name="pdd"onkeyup="harga()" />
                        ...
                        <script>
                          ...
                          <div class="masukan">
                            <input onkeyup="this.value = this.value.toUpperCase()"  type="text" id="effect5" class="effect-5" autocomplete="off" placeholder=" " name="kesimpulan" />
