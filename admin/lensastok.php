...
<div class="header__container">
    ...
    <div class="container" >
    <h5 style="text-align: center;">MASTER LENSA STOK</h5>
    <div >
        <br>
        <div>
            <a href="../admin/lensa.php" type="button" class="btn btn-danger">Kembali</a>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
Tambah Lensa Baru
</button>
            <a href="../admin/tambahlensaex.php" type="button" class="btn btn-success">Import Excel</a>
        </div>
        <br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Lensa Baru</h5>
      ...
      <div class="modal-body">
        ...
        ?>
        <form action="../admin/tambahlensabaru.php" method="post">
            <div class="form-group">
                
                    <label for="">Kode Lensa</label>
                    <input type="text" autocomplete="off"  onkeyup="this.value = this.value.toUpperCase()"  class="form-control"   name="kode_lensa">
             ...
             <div class="form-group">
                    ...
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="merk">
            ...
            <div class="form-group">
                    ...
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="jenis">
             ...
             <div class="form-group">
                    ...
                    <label for="">SPH</label>
                    <input   autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="sph" autocomplete="off">
            ...
            <div class="form-group">
                    ...
                    <label for="">CYL</label>
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="cyl" autocomplete="off">
            ...
            <div class="form-group">
                    ...
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="adisi" autocomplete="off">
            ...
            <div class="form-group">
                    ...
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="kategori" readonly value="STOK" autocomplete="off">
            ...
            <div class="form-group">
                    ...
                    <input   autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="qyt" autocomplete="off">
            ...
            <div class="form-group">
                    ...
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  id="harga_frame" class="form-control" name="harga" autocomplete="off">
