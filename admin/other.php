...
<div class="header__container">
    ...
    <div class="container" >
    <h5 style="text-align: center;">MASTER OTHER / AKSESORIS DLL</h5>
    <div >
...
<a href="../admin/tambahotherex.php" type="button" class="btn btn-success">IMPORT</a>
<br>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        include ('../config/koneksi.php');
         $pelanggan =  mysqli_query($konek, "SELECT max(kode) as id FROM master_barang where jenis='OTHER'");
        ...
        ?>
        <form action="../admin/tambahother.php" method="post">
            <div class="form-group">
                
                    <label for="">Kode</label>
                    <input autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control"  name="kode">
             ...
             <div class="form-group">
                    ...
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" value="OTHER" readonly  name="jenis">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                    ...
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="produk" autocomplete="off">
            ...
            <div class="form-group">
                    ...
                    <label for="">DETIL</label>
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="detil" autocomplete="off">
            ...
            <div class="form-group">
                    ...
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="stok" autocomplete="off">
