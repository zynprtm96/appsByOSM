...
<div class="header__container">
    ...
    <div class="container" >
    <h5 style="text-align: center;">MASTER LENSA</h5>
    <div >
        <br>
        <div>
            <a href="../admin/lensakatalog.php" type="button" class="btn btn-primary">Lensa Katalog</a>
            <a href="../admin/lensastok.php" type="button" class="btn btn-primary">Lensa Stok</a>
        </div>
        <br>
