...
<div class="header__container">
    ...
    <div class="container" >
    <h5 style="text-align: center;">MASTER FRAME</h5>
    <div >
...
<a href="../admin/tambahframeex.php" type="button" class="btn btn-success">IMPORT</a>
<br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Frame Baru</h5>
      ...
      <div class="modal-body">
        ...
        ?>
        <form action="../admin/tambahframe.php" method="post">
            <div class="form-group">
                
                    <label for="">Kode</label>
                    <input type="text" autocomplete="off"  onkeyup="this.value = this.value.toUpperCase()"  class="form-control"   name="kode">
             ...
             <div class="form-group">
                    ...
                    <input  autocomplete="off" type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" value="FRAME" readonly  name="jenis">
