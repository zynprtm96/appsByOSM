...
$data = mysqli_fetch_array($barang);
    ...
    <div  class="container">
    <form action="../admin/proseseditframe.php" method="post">
...
<table class="table table-borderless">
                    <tr>
                        ...
                        <td colspan="3">
                        <input type="text" value="<?php echo $data['kode']?>" readonly class="form-control" name="kode">
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">
                        ...
                        <td colspan="3">
                        <input type="text" value="<?php echo $data['jenis']?>" readonly  class="form-control" name="jenis">
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                        <input type="text" class="form-control" value="<?php echo $data['produk']?>"   name="produk">
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">
                        ...
                        <td colspan="3">
                        <input type="text" class="form-control" value="<?php echo $data['detil']?>"   name="detil">
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">
...
function ()
{
$('#hasil').load('../admin/dataeditframe.php?id=' + nota).fadeIn("slow");
}, 1000);
