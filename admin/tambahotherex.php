...
<div class="header__container">
    ...
    <div class="container" >
    <h5 style="text-align: center;">Import Other EXCEL</h5>
    <div >
    ...
    <?php
      ...
      $fileExtension = strtolower(end($fileExtension));
			...
			foreach($reader as $key => $row){
				...
				mysqli_query($konek, "INSERT INTO master_barang VALUES('', '$kode', 'OTHER', '$merk','$produk','$detil','$stok','$harga')");
			}
...
window.location.replace('../admin/tambahotherex.php');
} ,2000); 
</script>
";
		}
        ...
        <div>
            <a href="../admin/dtemplensstok.php?file=tamplate_other.xlsx" type="button" class="btn btn-success">Download Tamplate</a>
        </div>
        <div>
            <br>
            <p>Cara Pakai :</p>
