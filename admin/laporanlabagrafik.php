...
<div class="header__container">
    ...
    <form method="POST" action="" class="form-inline " >
     ...
     <a href="../admin/laporanlaba.php" type="button" class="btn btn-danger">Kembali</a>
...
?>
    ...
    <tbody>
        ...
        if (isset($_POST['search'])) {
            ...
            $tanggal = mysqli_query($konek,"SELECT  tanggal, sum(pemasukan) as pemasukan, sum(pengeluaran) as pengeluaran FROM laba group by month(tanggal) ");
            $masuk = mysqli_query($konek,"SELECT tanggal , sum(pemasukan) as pemasukan, sum(pengeluaran) as pengeluaran FROM laba group by month(tanggal)");
  ...
  var data = {
            ...
            datasets: [
            {
              label: "Laba",
              borderColor:"#45f248",
              data: [<?php while ($p2 = mysqli_fetch_array($masuk)) { 
                $laba = $p2['pemasukan'] - $p2['pengeluaran'];
                $nomer = number_format($laba);
