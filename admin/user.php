...
<div class="header__container">
    ...
    <div class="container" >
      <h5 style="text-align: center;">MASTER STAFF USER LOGIN</h5>
    <div >
	<br>
...
Tambah Petugas Baru
    ...
    <h6 style="text-align: center;">MASTER USER LOGIN</h6>
    <input type="text" class="form-control" id="search" width="50%" name="search" placeholder="Cari" >
    
    <div id="hasil" class="container">

    </div>
    <h6 style="text-align: center;">MASTER PETUGAS</h6>
    <input type="text" class="form-control" id="search1" width="50%" name="search" placeholder="Cari" >
    
    <div id="hasil1" class="container">
        ...
        <form action="../admin/register.php" method="post">
            <div class="form-group">
             ...
             <div class="form-group">
                    ...
                    <input autocomplete="off"  onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="username">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nohp" autocomplete="off">
...
<div class="modal fade " id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../admin/tambahpetugas.php" method="post">
