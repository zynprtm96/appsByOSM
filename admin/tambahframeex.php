...
<div class="header__container">
    ...
    <div class="container" >
    <h5 style="text-align: center;">Import Frame EXCEL</h5>
    <div >
    ...
    <?php
      ...
      $fileExtension = strtolower(end($fileExtension));
			...
			foreach($reader as $key => $row){
				...
				mysqli_query($konek, "INSERT INTO master_barang VALUES('', '$kode', 'FRAME', '$merk','$produk','$detil','$stok','$harga')");
			}
...
window.location.replace('../admin/tambahframeex.php');
} ,2000); 
</script>
";
        ...
        <div>
            <a href="../admin/dtemplensstok.php?file=tamplate_frame.xlsx" type="button" class="btn btn-success">Download Tamplate</a>
        </div>
        <div>
            <br>
            <p>Cara Pakai :</p>
            ...
            <p>5. Untuk Kode FRAME isi dengan format "F"</p>
            ...
            <p>LSPOLPROGPHT1.56-225-150+100D</p>
            <p>LS adalah kode untuk lensa stok</p>
            <p>POL adalah merk dari POLYCORE</p>
            <p>PROG adalah jenis lensa PROGRESIF</p>
            <p>PHT adalah Photo Grey</p>
            <p>1.56 adalah indeks bias lensa</p>
            <p>-225 adalah SPH</p>
            <p>-150 adalah CYL</p>
            <p>+100 adalah ADD</p>
            <p>D adalah DIOPTRI</p>
