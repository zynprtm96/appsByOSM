...
<div class="header__container">
    ...
    <div class="container" >
    <h5 style="text-align: center;">MASTER LENSA KATALOG</h5>
    <div >
        <br>
        <div>
            <a href="../admin/lensa.php" type="button" class="btn btn-primary">Kembali</a>
            <a href="../admin/tambahlensaexkatalog.php" type="button" class="btn btn-success">Import</a>
        </div>
        <br>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function load_data(search){
      $.ajax({
        url:"../proses/datalensakatalog.php",
        method:"POST",
        data: {
          search: search
        },
