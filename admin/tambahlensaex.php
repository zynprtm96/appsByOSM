...
<div class="header__container">
    ...
    <div class="container" >
    <h5 style="text-align: center;">Import Lensa STOK EXCEL</h5>
    <div >
...
window.location.replace('../admin/tambahlensaex.php');
} ,2000); 
</script>
";
		}
        ...
        <div>
            <a href="../admin/dtemplensstok.php?file=tamplate_lensastok.xlsx" type="button" class="btn btn-success">Download Tamplate</a>
        </div>
        <div>
            <br>
            <p>Cara Pakai :</p>
            ...
            <p>4. Untuk Kolom Kategori isi dengan "STOK"</p>
            <p>5. Untuk Kode Lensa isi dengan format "LS(merk+jenis+fitur+ukuran+D)"</p>
